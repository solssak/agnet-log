...
export const TabSwitcher = ({ sidebarTab, setSidebarTab, isAtTop }: Props) => {
  return (
    <div
      className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 flex gap-1 p-1 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-xl rounded-2xl border border-zinc-200/50 dark:border-white/10 shadow-lg transition-all duration-300 ${
        isAtTop
